...
var questionBank = ['Who has a big head?', 'Who has a blanket?', 'Who plays the piano?',
'Who has a best bird friend?', 'Who is Charlie Browns sister?', 'Who is the dirtiest character?',
'Who is known to be selfish, crabby or just bossy?', 'His arch nemisis is a kite?',
'She is the sweetest and the smartes of them all.', 'Who does Schroeder have sitting on his piano?',
'Who hosted a Halloween party at her house in It’s the Great Pumpkin Charlie Brown?',
'Who portrayed a shepherd in A Charlie Brown Christmas?',
'Which character has always believes in the "Great Pumpkin"?',
'He sometimes refers to the cloud that surrounds him with pride as the dust of ancient civilizations.'
];

var solutionBank = ['Charlie Brown', 'Linus', 'Schroeder', 'Snoopy', 'Sally Brown',
'Pig Pen', 'Lucy', 'Charlie Brown', 'Marcie', 'Lucy', 'Sally Brown', 'Linus', 'Linus', 'Pig Pen'
];
...
function checkAnswer(e) {
  ...
  if (e.textContent == answer) {
    ...
    var newContent = document.createTextNode('Correct !!!');
